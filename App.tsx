...
const ONBOARD_KEY = 'ai-dev-onboarded';
...
function App() {
  ...
  // ✅ Onboarding State (Lazy Init) — กัน Onboarding flicker
  ...
  useEffect(() => {
    ...
    else if (activeTab === Tab.Journey) setCurrentTheme('liquid');
    else setCurrentTheme('crystal');
  }, [activeTab]);
  ...
  const menuItems = [
    ...
    { id: Tab.Guide, label: 'Guide', icon: HelpCircle },
  ];
    ...
    <div className={`min-h-screen font-sans flex flex-col relative overflow-hidden ${isScanline ? 'scanline-active' : ''}`}>
          ...
          <div className="flex items-center justify-between h-20">
            <div className="flex items-center gap-3 cursor-pointer group" onClick={() => setActiveTab(Tab.Journey)}>
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-[var(--color-text-muted)] uppercase tracking-widest font-semibold">
                  V2.0 Signature
                </span>
              </div>
            </div>
              ...
              <div className="relative ml-2">
                ...
                {settingsOpen && (
                  <div className="absolute right-0 mt-2 w-64 rounded-[var(--radius-card)] bg-[var(--glass-bg)] border border-[var(--glass-border)] shadow-xl p-4 animate-slide-up backdrop-blur-xl">
                    <h4 className="text-xs font-bold text-[var(--color-text-muted)] uppercase tracking-widest mb-3">
                      Interface Theme
                    </h4>
      ...
      <main className="flex-grow max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 w-full relative z-10">
        ...
        {activeTab === Tab.Journey && (
          <HeroSection onStart={() => setActiveTab(Tab.Roadmap)} onBrowse={() => setActiveTab(Tab.Resources)} currentTheme={currentTheme} />
        )}
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="text-center md:text-left space-y-4">
              <div className="flex items-center justify-center md:justify-start gap-3">
                ...
                <span className="text-2xl font-bold text-[var(--color-text-main)] font-mono tracking-tight">
                  AI_Dev<span className="text-brand-400">.Platform</span>
                </span>
              </div>
            ...
            <div className="flex items-center gap-8">
              <a
                ...
                className="group flex items-center gap-2 text-[var(--color-text-muted)] hover:text-[var(--color-text-main)] transition-colors"
              >
